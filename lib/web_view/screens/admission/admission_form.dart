    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: FormBuilder(
          ...
          child: Column(
            children: <Widget>[
              AppRichTextView(title: "Program Applying For".toUpperCase(), fontSize: 20.sp, fontWeight: FontWeight.bold),
        // student Type
        FormBuilderCheckboxGroup<String>(
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      decoration: const InputDecoration(
                          labelText: 'Select Student Type'),
                      name: 'Student Type',
        ...
        FormBuilderCheckboxGroup<String>(
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      decoration: const InputDecoration(
                          labelText: 'Programme Applying For'),
                      name: 'Program',
                      // initialValue: const ['Dart'],
                      options: const [
        ...
        FormBuilderCheckboxGroup<String>(
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      decoration: const InputDecoration(
                          labelText: 'Semester Applying For'),
                      name: 'Semester',
                      // initialValue: const ['Dart'],
                      options: const [
                    ...
                    SizedBox(height: 10.h,),
                     AppRichTextView(title: "Previous Enrolment".toUpperCase(), fontSize: 20.sp, fontWeight: FontWeight.bold),
                     SizedBox(height: 10.h,),
                      Align(
                        alignment: Alignment.topLeft,
                        child: AppRichTextView(title: "Have you previously applied to stydy, or enroll at Rajiv Gandhi Univeristy of Science and Technology(RGUST) or one of its predecessor colleges?", fontSize: 15.sp, fontWeight: FontWeight.w500)),
                    ...
                    SizedBox(height: 10.h,),
             AppRichTextView(title: "${"Personal Details".toUpperCase()} (As they appear on your passport where applicable)", fontSize: 20.sp, fontWeight: FontWeight.bold),
                     SizedBox(height: 10.h,),
         ...
         FormBuilderTextField(
                      ...
                      onChanged: (val) {
                        setState(() {
                              ...
                              !(_formKey.currentState?.fields['Previous Name']?.validate() ??
                                  false);
                        });
                      },
                      // valueTransformer: (text) => num.tryParse(text),
