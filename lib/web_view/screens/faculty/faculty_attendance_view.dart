  ...
  Widget build(BuildContext context,) {
   ...
   var token = await getTokenAndUseIt();
      if (token == null) {
        ...
        var result = await timeSheetProvider.getFacultyAttendance(widget.facultyDetail.userId!, token);
          ...
          children: [
            Expanded(child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Text(calendarTapDetails.appointments![index].eventName);
              },
            ))
          ],
        ),
             ...
             crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Expanded(child: ListView.builder(
                  ...
                  itemCount: calendarTapDetails.appointments!.length,
                  itemBuilder: (context, index) {
                       DateTime startTime = calendarTapDetails.appointments![index].from;
String startformattedtime = DateFormat('h:mm a').format(startTime);
                       DateTime endTime = calendarTapDetails.appointments![index].to;
String endformattedtime = DateFormat('h:mm a').format(endTime);
                    return InkWell(
                      onTap: () {
                      ...
                      child: Card(
                        child: ListTile(
                          title: AppRichTextView( 
                            ...
                            title:calendarTapDetails.appointments![index].eventName),
                            subtitle: Row(
                              children: [
                               AppRichTextView( 
                            fontSize: 13.sp,
                            ...
                            title:widget.facultyDetail.firstName!)
                              ],
                            ),
                            trailing:Column(
                              children: [
                    AppRichTextView( 
                            ...
                            title:"Starts:$startformattedtime"),
                            AppRichTextView( 
                            fontSize: 15.sp,
                            fontWeight: FontWeight.bold,
                            textColor: AppColors.colorc7e,
                    
                            title:"Ends:$endformattedtime"),
                              ],
                            ) ,
                        ),
                      ),
