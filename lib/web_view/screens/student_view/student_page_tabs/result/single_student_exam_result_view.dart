...
class SingleStudentExamResultView extends StatefulWidget {
  final SingleStudentProfile? studentData;
  const SingleStudentExamResultView({super.key, this.studentData});

  @override
  State<SingleStudentExamResultView> createState() => _SingleStudentExamResultViewState();
}

class _SingleStudentExamResultViewState extends State<SingleStudentExamResultView> {
