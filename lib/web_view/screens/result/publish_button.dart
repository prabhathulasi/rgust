            ...
            if (resultConsumer.approvalModel.userType == "COE") {
              if (resultConsumer.approvalModel.approvalData!.isEmpty) {
                ...
                return AppElevatedButon(
                  ...
                  width: 150.w,
                  onPressed: (context) {
                    print(resultConsumer.approvalModel.approvalData!.length);
              ...
              } else if(resultConsumer.approvalModel.approvalData!.isNotEmpty &&  resultConsumer.approvalModel.approvalData![1].status !=
                      "Approved" ){
                 return AppElevatedButon(
                title: "Approve",
                borderColor: AppColors.colorWhite,
