...
import 'package:rugst_alliance_academia/web_view/screens/admission_form/admission_form_pages.dart';
                                    ...
                                    children: [
                                      ...
                                      Center(
                                        child: AppElevatedButon(
                                          loading:
                                              admissionLoginConsumer.isLoading,
                                            ...
                                            if (formKey.currentState!
                                              ...
                                              if (result.statusCode == 200) {
                                                ...
                                                if(decodedData["Status"] == 10){
                                                  ...
                                                  ToastHelper().errorToast("Application already submitted");
                                                }else{

                                                admissionLoginConsumer.setPage(true);
                                                }            
                                              }
                                            }
                                          },
