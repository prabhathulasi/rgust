...
class _SettingsTabViewState extends State<StaffSettingsTabView> {
                          ...
                          onPressed: (context) async {
                            if (formKey.currentState!.validate()) {
                              ...
                              if (token == null) {
                                ...
                                var result = await staffConsumer.createAccount(
                                    token,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<StaffProvider>(builder: (context, staffConsumer, child) {
        return Padding(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                staffConsumer.staffDetailModel.staff!.accountCreated == true
                    ? Container()
                    : InkWell(
                        onTap: () {
