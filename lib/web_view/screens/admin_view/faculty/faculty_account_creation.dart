                          ...
                          onPressed: (context) async {
                            if (formKey.currentState!.validate()) {
                              ...
                              if (token == null) {
                                ...
                                var result =
                                    await facultyProvider.createAccount(
            ...
            return facultyProvider.facultyModel.facultyList == null
                ...
                : Consumer<FacultyProvider>(
                    ...
                    return ListView.builder(
                      itemCount: facultyListProvider.facultyModel.facultyList!
                          .where((element) => element.accountCreated == false)
                          .length,
                      itemBuilder: (context, index) {
                        var data = facultyListProvider
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        AppRichTextView(
                                          title: data.firstName!.toUpperCase() +
