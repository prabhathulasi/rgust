...
import 'package:rugst_alliance_academia/web_view/screens/admin_view/student/doa_drop_down.dart';
import 'package:rugst_alliance_academia/web_view/screens/admin_view/student/instruction_view.dart';
import 'package:rugst_alliance_academia/web_view/screens/admin_view/student/student_fees_details.dart';
import 'package:rugst_alliance_academia/web_view/screens/admin_view/student/update_student_details/alerts/clinical_fee_alert.dart';
...
class _AddStudentViewState extends State<AddStudentView> {
  ...
  Widget build(BuildContext context) {
    final programConsumer = Provider.of<ProgramProvider>(
      context,
    );
    final studentConsumer = Provider.of<StudentProvider>(
      context,
    );
    final clincalConsumer = Provider.of<ClincialProvider>(
      context,
    );
                                      ...
                                      children: [
                                        Expanded(
                                          child: AppTextFormFieldWidget(
                                            ...
                                            onSaved: (p0) {
                                              studentConsumer.setStudentId(p0!);
                                            },
                                            inputDecoration:
                            ...
                            children: [
                              AppElevatedButon(
                                  ...
                                  onPressed: (context) async {
                                    ...
                                    } else if (programConsumer.selectedDept ==
                                        null) {
                                      ToastHelper().errorToast(
                                          "Please Select the Program");
                                    } else if (programConsumer.selectedClass ==
                                            null &&
                                        programConsumer.selectedDept != "300") {
                                      ToastHelper().errorToast(
                                          "Please Select the Class");
                                    } else if (programConsumer.selectedBatch ==
                                            null &&
                                        programConsumer.selectedDept != "300") {
                                      ToastHelper().errorToast(
                                          "Please Select the Batch");
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemCount: programConsumer
                                        .clinicalCoursesModel.clinicals!.length,
                                    itemBuilder: (context, index) {
                                                                ...
                                                                DateTime?
                                                                    ...
                                                                    await showDatePicker(
                                                                        ...
                                                                        context:
                                                                            context,
                                                                        initialDate:
                                                                            DateTime.parse(clincalConsumer
                                                                                .clincalStartDate!),
                                                                        firstDate:
                                                                            DateTime.parse(clincalConsumer
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  AppTextFormFieldWidget(
                                    onChanged: (p0) {
                                      departmentProvider.setEnableFilter(true);
                                      departmentProvider.filterCourses(p0);
                                    },
                                  ...
                                  SizedBox(height: 10.h),
                                  departmentProvider.filteredEnable ==
                                          true 
                                      ? Expanded(
                                        child: ListView.builder(
