...
import 'package:rugst_alliance_academia/web_view/screens/admin_view/pdf_generate/student_personal_profile.dart';
...
class _StudentAdditionalInfoViewState extends State<StudentAdditionalInfoView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: Consumer<FileUploadProvider>(
        builder: (context, fileUploadConsumer, child) {
          return FloatingActionButton(
            backgroundColor: AppColors.colorc7e,
            child: fileUploadConsumer.isLoading == false
                ? const Icon(
