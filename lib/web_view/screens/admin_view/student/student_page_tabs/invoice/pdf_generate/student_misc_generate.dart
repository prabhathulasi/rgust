...
Future<Uint8List> generateNewMiscInvoice(PdfPageFormat pageFormat,
    StudentDetail? studentData, MiscData invoiceData) async {
      ...
      pw.MultiPage(
        ...
        build: (context) => [
                  ...
                  pw.TableHelper.fromTextArray(
                    ...
                    data: [
                      [
                        invoiceData.miscInvoiceDescription!,
