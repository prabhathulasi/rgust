              ...
              child: Padding(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton(
                    ...
                    // Array list of items
                    items: admissionProgramConsumer.finInfo.map((String items) {
                      return DropdownMenuItem(
                        value: items,
                        child: Text(items),
                      );
                    ...
                    // change button value to selected value
                    onChanged: (String? newValue) {
                      admissionProgramConsumer.setFinInfoDropDownValue(newValue!);
                    },
                  ),
                ),
              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AppTextFormFieldWidget(
                          onSaved: (p0) => admissionProgramConsumer.enrolledUniversityName = p0,
                          validator: (p0) =>
                              p0!.isEmpty ? "University Name is required." : null,
                          obscureText: false,
                        ...
                        AppTextFormFieldWidget(
                          onSaved: (p0) => admissionProgramConsumer.enrolledProgramName = p0,
                          validator: (p0) =>
                              p0!.isEmpty ? "Program Name is required." : null,
                          obscureText: false,
                          inputDecoration: InputDecoration(
                              border: const OutlineInputBorder(),
                              focusedBorder: OutlineInputBorder(
                        ...
                        admissionProgramConsumer.selectedFileName == null
                                        ...
                                        if (result != null) {
                                          for (var file in result.files) {
                                            if (file.size / 1024 > 500) {
                                              ...
                                              admissionProgramConsumer.addFile(
                                                  file.name,
                            ...
                            : Card(
                                child: ListTile(
                                  title: Text(
                                      admissionProgramConsumer.selectedFileName!),
                                  trailing: IconButton(
                                    icon: const Icon(
                                      Icons.delete,
                              ...
                              if (admissionProgramConsumer.preEnrollRadio == "Yes") {
                                if (formKey.currentState!.validate()) {
                                  ...
                                  var response = await admissionProgramConsumer
                                      .postAdmissionProgramDetails(currentPageIndex, int.parse(applicationId!));
