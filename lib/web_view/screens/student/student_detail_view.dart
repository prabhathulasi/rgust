...
class _FacultyDetailViewState extends State<StudentDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    Future getStudentDetail() async {
      ...
      if (token == null) {
        ...
        var result = await studentProvider.getStudentDetailById(widget.studentId, token);
 ...
 final studentData = studentProvider.studentDetailModel.studentDetail!;
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            onTap: () async{
                                              ...
                                              studentProvider.clearStudentTemp();
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        AppRichTextView(
                                          title: studentData.emergencyContact!
                                              .toString(),
                                          fontSize: 12.sp,
                                          fontWeight: FontWeight.w800,
                                          textColor: AppColors.colorWhite,
