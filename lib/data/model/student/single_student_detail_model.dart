...
class SingleStudentDetailModel {
  String? message;
  SingleStudentProfile? studentDetail;

  SingleStudentDetailModel({this.message, this.studentDetail});

  SingleStudentDetailModel.fromJson(Map<String, dynamic> json) {
    message = json['Message'];
    studentDetail = json['Profile'] != null
        ? SingleStudentProfile.fromJson(json['Profile'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (studentDetail != null) {
      data['Profile'] = studentDetail!.toJson();
    }
    return data;
  }
}
...
class SingleStudentProfile {
  ...
  SingleStudentProfile.fromJson(Map<String, dynamic> json) {
    iD = json['ID'];
