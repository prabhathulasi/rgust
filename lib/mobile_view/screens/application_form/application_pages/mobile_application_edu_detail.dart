...
class MobileApplicationEduDetail extends StatelessWidget {
  final PageController pageController;
  const MobileApplicationEduDetail({super.key, required this.pageController});
